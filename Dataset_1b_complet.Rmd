...
data = read_excel("dataset_1b_complete.xlsx")
...
data$Figure_memory_1 = replace_outliers(data$Figure_memory_1)
data$Figure_memory_2 = replace_outliers(data$Figure_memory_2)
data$Words_30s = replace_outliers(data$Words_30s)
data$Words_1min = replace_outliers(data$Words_1min)
data$Animals_30s = replace_outliers(data$Animals_30s)
data$Animals_1min = replace_outliers(data$Animals_1min)
data$Denomination = replace_outliers(data$Denomination)
data$Free_memory_1 = replace_outliers(data$Free_memory_1)
data$Free_memory_2 = replace_outliers(data$Free_memory_2)
data$Free_memory_3 = replace_outliers(data$Free_memory_3)
data$Face_memory_1 = replace_outliers(data$Face_memory_1)
data$Face_memory_2 = replace_outliers(data$Face_memory_2)
data$Face_memory_3 = replace_outliers(data$Face_memory_3)
data$Total_memory = replace_outliers(data$Total_memory)
data$Boston = replace_outliers(data$Boston)
data$Stroop_words = replace_outliers(data$Stroop_words)
data$Stroop_colors = replace_outliers(data$Stroop_colors)
data$Stroop_words_colors = replace_outliers(data$Stroop_words_colors)
data$Stroop_total_punctuation = replace_outliers(data$Stroop_total_punctuation)
data$Raven_matrices = replace_outliers(data$Raven_matrices)
data$Trail_A_time = replace_outliers(data$Trail_A_time)
data$Trail_B_time = replace_outliers(data$Trail_B_time)
data$Trail_B_errors = replace_outliers(data$Trail_B_errors)
data$ADAS_test_1 = replace_outliers(data$ADAS_test_1)
data$ADAS_test_2 = replace_outliers(data$ADAS_test_2)
data$ADAS_test_3 = replace_outliers(data$ADAS_test_3)
data$ADAS_memory = replace_outliers(data$ADAS_memory)
data$ADAS_recognition = replace_outliers(data$ADAS_recognition)
...
percentage_na_columns = colMeans(is.na(data[ , -c(1)]))*100
limit = 30
removed_columns = which(percentage_na_columns >= limit)
removed_columns
...
form = as.formula(paste("Conversion ~", covariates))
